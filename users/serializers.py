...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        validated_data.pop("password2") ## database'e göndermemek icin!
        # create new user:
        user = User.objects.create(**validated_data) ## iki yildiz key,value sekline ceviriyor. Validated_data ile fields kismindakilerden zorunlu olarak geliyor.
        # encrypt password:
